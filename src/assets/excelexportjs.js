...
(function($) {
    ...
    $.fn.excelexportjs = function(options) {
        ...
        function exportToExcelIE(table) {
            ...
            {
                txtArea1.document.open("txt/html", "replace", "_parent");
                txtArea1.document.write(tab_text);
                txtArea1.document.close();
                txtArea1.focus();
                sa = txtArea1.document.execCommand("SaveAs", true, $settings.filename);
            } else
                sa = window.open('data:application/vnd.ms-excel,' + encodeURIComponent(tab_text), "_parent");
            return (sa);
        }
